...
//		txtResult = obj.getBarcodeFormat().toString() + ":"+ obj.getText();
		txt = obj.getText();
		switch(name.length()){
		case 19:
		Intent intent = new Intent();
		intent.setClass(CaptureActivity.this, SetupDetailActivity.class);
		intent.putExtra("meter",txt);
		...
		case 12:
			...
			intent1.putExtra("meter",txt);
			intent1.putExtra("user",loginUser);
